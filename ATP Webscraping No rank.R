...
for (i in 1:nrow(match_data)) {
  ...
  wl_dif <- ifelse(is.na(p1_wl) | is.na(p2_wl), NA, abs(p1_wl - p2_wl))
  ...
  titles_dif <- ifelse(is.na(p1_titles) | is.na(p2_titles), NA, abs(p1_titles - p2_titles))
  ...
  age_dif <- ifelse(is.na(player1_age) | is.na(player2_age), NA, abs(player1_age - player2_age))
  ...
  height_dif <- ifelse(is.na(player1_height) | is.na(player2_height), NA, abs(player1_height - player2_height))
  ...
  weight_dif <- ifelse(is.na(player1_weight) | is.na(player2_weight), NA, abs(player1_weight - player2_weight))
